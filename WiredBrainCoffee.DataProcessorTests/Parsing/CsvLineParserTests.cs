...
public class CsvLineParserTests
{
    ...
    [Theory]
    public void ShouldThrowExceptionForInvalidLine(string csvLine, string exceptedMessagePrefix)
    {
        // Arrange
        ...
        Assert.Equal($"{exceptedMessagePrefix}: {csvLine}", exception.Message);
    }
}
